from gear_ratios import get_coordinates_to_check, get_part_numbers, get_gears_ratios
...
def test_even_more_advanced_test_case():
    multi_lines_str = """12.......*..
+.........34
.......-12..
..78........
...
1.1..503+.56"""
    ...
    assert sum(get_part_numbers(multi_lines_str)) == 925


def test_calculate_gears_ratios():
    multi_lines_str = """467..114..
...*......
..35..633.
......#...
...
.664.598.."""
    ...
    assert get_gears_ratios(multi_lines_str) == [16345, 451490]
